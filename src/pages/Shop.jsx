...
const Shop = () => {
  ...
  const fetchProducts = async (page = 1) => {
    try {
      ...
      // Handle the response properly - this is the key fix
      if (response && response.data && Array.isArray(response.data)) {
        // This is the correct structure: response.data is the array of products
  ...
  return (
    <div className="shop-page container mx-auto px-4 py-8">
      ...
      {/* Simplified Filters - removed price filters */}
