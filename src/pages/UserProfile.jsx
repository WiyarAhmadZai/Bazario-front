    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 rounded-2xl shadow-2xl p-6 mb-8 border border-gray-700">
        <div className="flex flex-col lg:flex-row items-center">
          {/* Profile Image Section - Much More Prominent */}
          <div className="relative mb-4 lg:mb-0 lg:mr-8">
            <div className="relative">
              {/* Main Profile Image - Much Larger */}
              <div 
                className="h-48 w-48 lg:h-56 lg:w-56 rounded-full overflow-hidden border-4 border-gold shadow-2xl ring-4 ring-gold/20 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-3xl"
              ...
              >
                ...
                <div className="bg-gradient-to-br from-gold via-yellow-500 to-yellow-600 h-full w-full flex items-center justify-center" style={{display: user.avatar ? 'none' : 'flex'}}>
                  <span className="text-black font-bold text-6xl lg:text-7xl">{user.name?.charAt(0) || 'U'}</span>
                </div>
              </div>
          ...
          {/* User Info Section - Smaller and Compact */}
          <div className="text-center lg:text-left flex-1 max-w-md">
            <div className="mb-3">
              <h1 className="text-2xl lg:text-3xl font-bold text-white mb-1 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                {user.name}
              </h1>
              <div className="flex items-center justify-center lg:justify-start text-xs text-gray-400 mb-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              {user.phone && (
                <button
                  ...
                  className="group flex flex-col items-center justify-center bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-2 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-green-400/20"
                  title="Call"
                >
                  <PhoneIcon />
              ...
              {user.phone && (
                <button
                  ...
                  className="group flex flex-col items-center justify-center bg-gradient-to-br from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white p-2 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-green-300/20"
                  title="WhatsApp"
                >
                  <WhatsappIcon />
              ...
              {user.email && (
                <button
                  ...
                  className="group flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white p-2 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-blue-400/20"
                  title="Email"
                >
                  <EnvelopeIcon />
              ...
              {(user.address || user.city || user.country) && (
                <button
                  ...
                  className="group flex flex-col items-center justify-center bg-gradient-to-br from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white p-2 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-red-400/20"
                  title="Location"
                >
                  <MapIcon />
              ...
              <div className="flex flex-wrap gap-2">
                {user.profession && (
                  <div className="flex items-center space-x-2 bg-gray-800/50 px-3 py-2 rounded-lg border border-gray-600">
                    <BriefcaseIcon />
                    <span className="text-xs font-medium text-gray-300">{user.profession}</span>
                  </div>
                )}
                {user.city && user.country && (
                  <div className="flex items-center space-x-2 bg-gray-800/50 px-3 py-2 rounded-lg border border-gray-600">
                    <GlobeIcon />
                    <span className="text-xs font-medium text-gray-300">{user.city}, {user.country}</span>
                  </div>
                )}
              </div>
            </div>
